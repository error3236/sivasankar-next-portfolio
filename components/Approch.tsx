...
const Approch = () =>{
  return (
    <section className="w-full" id='approch'>
...
const AceternityIcon = ({order}:{order:string}) => {
  return (
  <div>
    <button className="px-12 py-2 rounded-full relative  text-white text-sm hover:shadow-2xl hover:shadow-white/[0.1] transition duration-200 border border-slate-600">
